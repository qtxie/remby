...
static EN: phf::Map<&'static str, &'static str> = phf::phf_map! {
    ...
    "title.help" => "Help",
    "title.items" => "Items",
    "series.no_overview" => "No overview available",
    "series.no_cast" => "No cast information",
    "filter.all" => "All",
    "sort.name" => "Name",
    "sort.year" => "Year",
    "sort.rating" => "Rating",
    "sort.date_added" => "Date Added",
    "filter.genre" => "Genre",
    "filter.tag" => "Tag",
    "filter.studio" => "Studio",
    "filter.year" => "Year",
    "filter.folder" => "Folder",
    "hint.toggle" => "(←/→ to switch)",
    "settings.language" => "Language",
    "settings.theme" => "Theme",
    "settings.track_preferences" => "Track Preferences",
    "settings.resolution" => "Resolution",
    "settings.audio_language" => "Audio Language",
    "settings.subtitle_language" => "Subtitle Language",
    "settings.language.off" => "Off",
    "settings.language.any" => "Any",
    "title.help_label" => "Help: {}",
    ...
    "footer.series_info" => "←/→: section | Enter: open | f: follow | a: cast | e: episodes | ?: help",
    "footer.cast" => "↑/↓: scroll | PageUp/Dn: jump | Enter/Esc/a: close",
    "footer.settings" => "Tab: section | ←→: value | ↑↓: field | Space: toggle | Enter: save | ?: help",
    ...
    "error.account_unreadable" => "Saved password cannot be decrypted on this device, sign in again",
...
static ZH: phf::Map<&'static str, &'static str> = phf::phf_map! {
    ...
    "title.help" => "帮助",
    "title.items" => "项目",
    "series.no_overview" => "暂无简介",
    "series.no_cast" => "暂无演员信息",
    "filter.all" => "全部",
    "sort.name" => "名称",
    "sort.year" => "年份",
    "sort.rating" => "评分",
    "sort.date_added" => "添加日期",
    "filter.genre" => "类型",
    "filter.tag" => "标签",
    "filter.studio" => "工作室",
    "filter.year" => "年份",
    ...
    "settings.theme" => "主题",
    "settings.track_preferences" => "轨道偏好",
    "settings.resolution" => "分辨率",
    "settings.audio_language" => "音频语言",
    "settings.subtitle_language" => "字幕语言",
    "settings.language.off" => "关闭",
    "settings.language.any" => "自动",
    "title.help_label" => "帮助: {}",
    "media.container" => "容器:",
    "media.size" => "大小:",
    "media.video" => "视频:",
    ...
    "footer.series_info" => "←/→: 分区 | 回车: 打开 | f: 追剧 | a: 演员 | e: 剧集 | ?: 帮助",
    "footer.cast" => "↑/↓: 滚动 | 翻页: 跳转 | 回车/Esc/a: 关闭",
    "footer.settings" => "Tab: 分区 | ←→: 值 | ↑↓: 字段 | 空格: 切换 | 回车: 保存 | ?: 帮助",
    ...
    "error.account_unreadable" => "保存的密码在本机无法解密，请重新登录",
